...
1. Get the definition using either `Get-AzPolicySetDefinition` for initiatives or `Get-AzPolicyDefinition` for policies.
...
1. Create the assignment using the parameters.
...
1. Assign the required role to the identity created for the policy assignment. Find the role in the policy definition by searching for *roleDefinitionIds*
