...
|---|---|---|---|---|---|---|---|
|**Bastion Communication Status**<br><br>Communication status shows 1 if all communication is good and 0 if its bad. |`pingmesh` | No | Count |Average |\<none\>|PT1M |No|

### Category: Saturation
|Metric|Name in REST API|[Advanced platform metrics](/azure/azure-monitor/metrics/metrics-advanced-platform)|Unit|Aggregation|Dimensions|Time Grains|DS Export|
|---|---|---|---|---|---|---|---|
|**Total Memory**<br><br>Total memory stats. |`total` | No | Count |Average |`host`|PT1M |Yes|
|**CPU Usage**<br><br>CPU Usage stats. |`usage_user` | No | Count |Average |`cpu`, `host`|PT1M |No|
|**Memory Usage**<br><br>Memory Usage stats. |`used` | No | Count |Average |`host`|PT1M |Yes|

### Category: Traffic
|Metric|Name in REST API|[Advanced platform metrics](/azure/azure-monitor/metrics/metrics-advanced-platform)|Unit|Aggregation|Dimensions|Time Grains|DS Export|
|---|---|---|---|---|---|---|---|
|**Session Count**<br><br>Sessions Count for the Bastion. View in sum and per instance. |`sessions` | No | Count |Total (Sum), Average |`host`|PT5M, PT15M |No|
