...
|---|---|---|---|---|---|---|---|
|**CPU Percentage**<br><br>The average CPU used across all instances of the worker pool. |`CpuPercentage` | No | Percent |Average |`Instance`|PT1M |Yes|
|**Memory Percentage**<br><br>The average memory used across all instances of the worker pool. |`MemoryPercentage` | No | Percent |Average |`Instance`|PT1M |Yes|
|**Available Workers**<br><br>Available Workers |`WorkersAvailable` | No | Count |Average |\<none\>|PT1M |Yes|
|**Total Workers**<br><br>Total Workers |`WorkersTotal` | No | Count |Average |\<none\>|PT1M |Yes|
|**Used Workers**<br><br>Used Workers |`WorkersUsed` | No | Count |Average |\<none\>|PT1M |Yes|
