...
|---|---|---|---|---|---|---|---|
|**Requests Latencies**<br><br>How long it takes to get request response |`RequestLatency` | No | Milliseconds |Average |`Operation`, `Authentication`, `Protocol`, `ResourceId`, `Region`|PT1M |Yes|
|**Requests Traffic**<br><br>Number of requests within a given period of time |`RequestsTraffic` | No | Count |Average |`Operation`, `Authentication`, `Protocol`, `ResourceId`, `Region`, `StatusCode`, `StatusCodeClass`, `StatusText`|PT1M |Yes|
