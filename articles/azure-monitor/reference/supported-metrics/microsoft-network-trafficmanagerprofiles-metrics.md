...
|---|---|---|---|---|---|---|---|
|**Endpoint Status by Endpoint**<br><br>1 if an endpoint's probe status is "Enabled", 0 otherwise. |`ProbeAgentCurrentEndpointStateByProfileResourceId` | No | Count |Maximum |`EndpointName`|PT1M, PT1H |Yes|
|**Queries by Endpoint Returned**<br><br>Number of times a Traffic Manager endpoint was returned in the given time frame |`QpsByEndpoint` | No | Count |Total (Sum) |`EndpointName`|PT1M, PT1H |Yes|
