...
|---|---|---|---|---|---|---|---|
|**Flow Records**<br><br>Flow Records Processed by ATC. |`count` | No | Count |Average, Total (Sum) |`RoleInstance`, `Circuit`|PT1M |Yes|
|**CPU Usage**<br><br>CPU Usage Percentage. |`usage_active` | No | Percent |Average, Minimum, Maximum |`Hostname`|PT5M, PT15M, PT30M, PT1H, PT6H, PT12H, P1D |Yes|
|**Memory Usage**<br><br>Memory Usage Percentage. |`used_percent` | No | Percent |Average |`Hostname`|PT1M |Yes|
