...
|---|---|---|---|---|---|---|
|**Data Volume**<br><br>Total bytes of Data. |`DataVolume` |Bytes |Average |`Tier`, `DataPartition`|PT1H |No|

### Category: Traffic
|Metric|Name in REST API|Unit|Aggregation|Dimensions|Time Grains|DS Export|
|---|---|---|---|---|---|---|
|**Total Http requests**<br><br>Total number of HTTP Requests in a specified time period. |`TotalHttpRequests` |Count |Total (Sum) |`destination_workload`, `data_partition_id`, `request_method`, `response_code`|PT1M |Yes|
