...
|---|---|---|---|---|---|---|---|
|**Fleetspace Autoscaled Throughput (Preview)**<br><br>The throughput scaled to by the fleetspace pool within the time range. |`FleetspaceAutoscaledThroughput` | No | Count |Maximum |`Region`, `FleetspaceName`|PT5M, PT15M, PT30M, PT1H, PT6H, PT12H, P1D |Yes|
