...
|---|---|---|---|---|---|---|---|
|**Failed Runs**<br><br>Failed Runs |`FailedRuns` | No | Count |Total (Sum) |`pipelineName`, `activityName`|PT1H |Yes|
|**Successful Runs**<br><br>Successful Runs |`SuccessfulRuns` | No | Count |Total (Sum) |`pipelineName`, `activityName`|PT1H |Yes|
