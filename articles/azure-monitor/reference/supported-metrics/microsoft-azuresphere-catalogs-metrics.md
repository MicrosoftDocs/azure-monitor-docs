...
|---|---|---|---|---|---|---|---|
|**Catalog Certificate Days To Expiration**<br><br>Total number of days remaining for the Catalog Certificate to expire. Alert on this metric to get notified ahead of the certificate expiration date. |`CatalogCertificateDaysToExpiration` | No | Count |Minimum |\<none\>|P1D |Yes|

### Category: Device
|Metric|Name in REST API|[Advanced platform metrics](/azure/azure-monitor/metrics/metrics-advanced-platform)|Unit|Aggregation|Dimensions|Time Grains|DS Export|
|---|---|---|---|---|---|---|---|
|**Device Events**<br><br>Count of all the events generated by an Azure Sphere device. |`DeviceEventsCount` | No | Count |Count |`DeviceId`, `EventCategory`, `EventClass`, `EventType`|PT1M |Yes|
|**Device Requests**<br><br>Count of all the requests sent by an Azure Sphere device. |`DeviceRequestsCount` | No | Count |Count |`DeviceId`, `OperationName`, `ResultType`|PT1M |Yes|
