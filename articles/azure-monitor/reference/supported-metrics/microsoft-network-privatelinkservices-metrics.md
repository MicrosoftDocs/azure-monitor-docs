...
|---|---|---|---|---|---|---|---|
|**Bytes In**<br><br>Total number of Bytes In |`PLSBytesIn` | No | Count |Total (Sum) |\<none\>|PT1M |Yes|
|**Bytes Out**<br><br>Total number of Bytes Out |`PLSBytesOut` | No | Count |Total (Sum) |\<none\>|PT1M |Yes|
|**Nat Ports Usage**<br><br>Nat Ports Usage |`PLSNatPortsUsage` | No | Percent |Average |`PrivateLinkServiceIPAddress`|PT1M |Yes|
