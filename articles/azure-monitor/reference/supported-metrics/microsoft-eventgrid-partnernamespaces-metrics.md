...
|---|---|---|---|---|---|---|---|
|**Publish Failed Events**<br><br>Total events failed to publish to this partner namespace |`PublishFailCount` | No | Count |Total (Sum) |`ErrorType`, `Error`|PT1M |Yes|
|**Published Events**<br><br>Total events published to this partner namespace |`PublishSuccessCount` | No | Count |Total (Sum) |\<none\>|PT1M |Yes|
...
|**Unmatched Events**<br><br>Total events not matching any of the partner topics |`UnmatchedEventCount` | No | Count |Total (Sum) |\<none\>|PT1M |Yes|
