...
|---|---|---|---|---|---|---|---|
|**Latency**<br><br>Latency data for all requests to Azure Resource Manager |`Latency` | No | Seconds |Average |`IsCustomerOriginated`, `Method`, `Namespace`, `RequestRegion`, `ResourceType`, `StatusCode`, `StatusCodeClass`, `Microsoft.SubscriptionId`, `OperationType`|PT1M |No|
|**Traffic**<br><br>Traffic data for all requests to Azure Resource Manager |`Traffic` | No | Count |Count |`IsCustomerOriginated`, `Method`, `Namespace`, `RequestRegion`, `ResourceType`, `StatusCode`, `StatusCodeClass`, `Microsoft.SubscriptionId`, `OperationType`|PT1M |No|
