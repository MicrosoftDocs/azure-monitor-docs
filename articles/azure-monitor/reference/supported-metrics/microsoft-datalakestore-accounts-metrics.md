...
|---|---|---|---|---|---|---|---|
|**Data Read**<br><br>Total amount of data read from the account. |`DataRead` | No | Bytes |Total (Sum) |\<none\>|PT1M, PT1H |Yes|
|**Data Written**<br><br>Total amount of data written to the account. |`DataWritten` | No | Bytes |Total (Sum) |\<none\>|PT1M, PT1H |Yes|
|**Read Requests**<br><br>Count of data read requests to the account. |`ReadRequests` | No | Count |Total (Sum) |\<none\>|PT1M, PT1H |Yes|
|**Total Storage**<br><br>Total amount of data stored in the account. |`TotalStorage` | No | Bytes |Maximum |\<none\>|PT1M, PT1H |Yes|
|**Write Requests**<br><br>Count of data write requests to the account. |`WriteRequests` | No | Count |Total (Sum) |\<none\>|PT1M, PT1H |Yes|
