...
|---|---|---|---|---|---|---|---|
|**Failed Requests**<br><br>Gets the available logs for Custom Resource Providers |`FailedRequests` | No | Count |Total (Sum) |`HttpMethod`, `CallPath`, `StatusCode`|PT15M, PT1H, PT12H, P1D |Yes|
|**Successful Requests**<br><br>Successful requests made by the custom provider |`SuccessfullRequests` | No | Count |Total (Sum) |`HttpMethod`, `CallPath`, `StatusCode`|PT15M, PT1H, PT12H, P1D |Yes|
