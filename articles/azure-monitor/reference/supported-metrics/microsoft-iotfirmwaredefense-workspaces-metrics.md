...
|---|---|---|---|---|---|---|---|
|**Firmware Analysis Error Count**<br><br>Count of firmware uploads that errored or timed out |`FirmwareAnalysisErrorCount` | No | Count |Count, Total (Sum) |`AnalyzerType`|PT1M |Yes|
|**Firmware Analysis Latency**<br><br>Average time taken to complete firmware analysis |`FirmwareAnalysisLatency` | No | Milliseconds |Average, Minimum, Maximum, Total (Sum) |\<none\>|PT1M |Yes|
