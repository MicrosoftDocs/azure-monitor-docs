...
|---|---|---|---|---|---|---|---|
|**Total number of cpu cores in a provisioned cluster**<br><br>Total number of cpu cores in a provisioned cluster |`capacity_cpu_cores` | No | Count |Total (Sum), Average |\<none\>|PT1M |Yes|
