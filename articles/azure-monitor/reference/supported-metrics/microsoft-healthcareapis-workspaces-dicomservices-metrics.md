...
|---|---|---|---|---|---|---|---|
|**Number of DICOM files processed by import**<br><br>The total number of DICOM files processed by an import. |`ImportsProcessed` | No | Count |Total (Sum) |`Status`, `ResourceName`|PT1M |Yes|
