...
|---|---|---|---|---|---|---|
|**Bytes In**<br><br>Total number of Bytes In |`PEBytesIn` |Count |Total (Sum) |\<none\>|PT1M |No|
|**Bytes Out**<br><br>Total number of Bytes Out |`PEBytesOut` |Count |Total (Sum) |\<none\>|PT1M |No|
