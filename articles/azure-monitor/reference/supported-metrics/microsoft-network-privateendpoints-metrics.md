...
|---|---|---|---|---|---|---|---|
|**Bytes In**<br><br>Total number of Bytes In |`PEBytesIn` | No | Count |Total (Sum) |\<none\>|PT1M |No|
|**Bytes Out**<br><br>Total number of Bytes Out |`PEBytesOut` | No | Count |Total (Sum) |\<none\>|PT1M |No|
