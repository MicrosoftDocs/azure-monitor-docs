...
|---|---|---|---|---|---|---|---|
|**Resolver Policy Rule Count**<br><br>This metric indicates the number of rules present in each DNS Resolver Policy. |`ResolverPolicyRuleCount` | No | Count |Average, Minimum, Maximum, Count |\<none\>|PT1H, PT6H, PT12H, P1D |Yes|
|**Virtual Network Link Count**<br><br>This metric indicates the number of associated virtual network links to a Resolver Policy. |`ResolverPolicyVNetLinksCount` | No | Count |Average, Minimum, Maximum, Count |\<none\>|PT1H, PT6H, PT12H, P1D |Yes|
