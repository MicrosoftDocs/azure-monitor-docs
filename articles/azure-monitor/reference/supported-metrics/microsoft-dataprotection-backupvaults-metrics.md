...
|---|---|---|---|---|---|---|---|
|**Backup Health Events**<br><br>The count of health events pertaining to backup job health |`BackupHealthEvent` | No | Count |Count |`dataSourceURL`, `backupInstanceUrl`, `dataSourceType`, `healthStatus`, `backupInstanceName`, `isResourceMetricReady`|PT1M, PT5M, PT15M, PT30M, PT1H, PT6H, PT12H, P1D |No|
|**Restore Health Events**<br><br>The count of health events pertaining to restore job health |`RestoreHealthEvent` | No | Count |Count |`dataSourceURL`, `backupInstanceUrl`, `dataSourceType`, `healthStatus`, `backupInstanceName`, `isResourceMetricReady`|PT1M, PT5M, PT15M, PT30M, PT1H, PT6H, PT12H, P1D |No|
