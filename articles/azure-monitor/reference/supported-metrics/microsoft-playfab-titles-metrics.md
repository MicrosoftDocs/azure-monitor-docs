...
|---|---|---|---|---|---|---|---|
|**PlayerLoggedInCount**<br><br>Number of logins by any player in a given title |`PlayerLoggedInCount` | No | Count |Average, Maximum, Minimum, Total (Sum), Count |`TitleId`|PT1M |Yes|
