...
|---|---|---|---|---|---|---|---|
|**Job Execution**<br><br>Execution of a Job |`JobExecution` | No | Count |Count |`FinalState`|PT1M |Yes|
|**Job Latency**<br><br>Latency of a Job Execution |`JobLatency` | No | Seconds |Average, Maximum, Minimum |`FinalState`|PT1M |Yes|
