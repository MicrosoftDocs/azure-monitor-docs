...
|---|---|---|---|---|---|---|---|
|**CPU Utilization (%)**<br><br>Total processor usage across all cores of the API gateway. |`CpuPercent_Gateway` | No | Percent |Average, Maximum |\<none\>|PT1M |Yes|
|**Memory Utilization (%)**<br><br>Percentage of physical memory in use by active processes within the API gateway. |`MemoryPercent_Gateway` | No | Percent |Average, Maximum |\<none\>|PT1M |Yes|
