...
|---|---|---|---|---|---|---|---|
|**Request Latency**<br><br>Time taken by the server to process the request |`RequestLatency` | No | Milliseconds |Total (Sum) |`Operation`, `Authentication`, `Protocol`, `DataCenter`|PT1M |Yes|

### Category: Traffic
|Metric|Name in REST API|[Advanced platform metrics](/azure/azure-monitor/metrics/metrics-advanced-platform)|Unit|Aggregation|Dimensions|Time Grains|DS Export|
|---|---|---|---|---|---|---|---|
|**Requests Traffic**<br><br>Number of Requests Made |`RequestsTraffic` | No | Percent |Count |`Operation`, `Authentication`, `Protocol`, `StatusCode`, `StatusCodeClass`, `DataCenter`|PT1M |Yes|
