...
|**Queries Per Second**<br><br>This metric indicates the queries per second for a DNS Resolver. (Can be aggregated per EndpointId) |`QPSMdm` | No | Count |Total (Sum) |`EndpointArmResourceId`|PT1M |No|
