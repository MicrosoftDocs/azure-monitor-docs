...
|---|---|---|---|---|---|---|---|
|**Action CPU Time**<br><br>CPU Time consumed by the action code. |`action_cpu_time_millis` | No | Milliseconds |Average |`result`, `error`|PT1M |Yes|
|**Action Execution Time**<br><br>Wall Time taken to execute the action code. |`action_execution_latency` | No | Milliseconds |Average |`result`, `error`|PT1M |Yes|
