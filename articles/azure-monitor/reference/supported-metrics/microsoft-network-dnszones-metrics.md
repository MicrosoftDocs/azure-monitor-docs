...
|---|---|---|---|---|---|---|---|
|**Query Volume**<br><br>Number of queries served for a DNS zone |`QueryVolume` | No | Count |Total (Sum) |\<none\>|PT1H |No|
|**Record Set Capacity Utilization**<br><br>Percent of Record Set capacity utilized by a DNS zone |`RecordSetCapacityUtilization` | No | Percent |None, Average, Minimum, Maximum, Count |\<none\>|PT1H |No|
|**Record Set Count**<br><br>Number of Record Sets in a DNS zone |`RecordSetCount` | No | Count |None, Average, Minimum, Maximum, Count |\<none\>|PT1H |No|
