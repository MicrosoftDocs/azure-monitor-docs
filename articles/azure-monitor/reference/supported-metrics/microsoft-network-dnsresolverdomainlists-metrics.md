...
|---|---|---|---|---|---|---|---|
|**Domain List Rule Count**<br><br>This metric indicates the number of domain list present in each DNS Resolver Domain List. |`DomainListRuleCount` | No | Count |Average, Minimum, Maximum, Count |\<none\>|PT1H, PT6H, PT12H, P1D |Yes|
|**Number Of Domains Count**<br><br>This metric indicates the number of domains in a DNS Resolver Domain List. |`NumberOfDomainsCount` | No | Count |Average, Minimum, Maximum, Count |\<none\>|PT1H, PT6H, PT12H, P1D |Yes|
