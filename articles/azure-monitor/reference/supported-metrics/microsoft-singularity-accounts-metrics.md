...
|---|---|---|---|---|---|---|---|
|**GpuUtilizationPercentage**<br><br>GPU utilization percentage |`GpuUtilizationPercentage` | No | Percent |Average |`accountname`, `ClusterName`, `Environment`, `instance`, `jobContainerId`, `jobInstanceId`, `jobname`, `Region`|PT1M |Yes|
