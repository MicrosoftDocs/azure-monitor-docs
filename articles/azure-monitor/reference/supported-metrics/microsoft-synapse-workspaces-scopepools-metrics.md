...
|---|---|---|---|---|---|---|---|
|**PN duration of SCOPE job**<br><br>PN (process node) duration (Milliseconds) used by each SCOPE job |`ScopePoolJobPNMetric` | No | Milliseconds |Maximum, Minimum, Average, Total (Sum), Count |`JobType`, `JobResult`|PT1M |Yes|
|**Queued duration of SCOPE job**<br><br>Queued duration (Milliseconds) used by each SCOPE job |`ScopePoolJobQueuedDurationMetric` | No | Milliseconds |Maximum, Minimum, Average, Total (Sum), Count |`JobType`|PT1M |Yes|
|**Running duration of SCOPE job**<br><br>Running duration (Milliseconds) used by each SCOPE job |`ScopePoolJobRunningDurationMetric` | No | Milliseconds |Maximum, Minimum, Average, Total (Sum), Count |`JobType`, `JobResult`|PT1M |Yes|
