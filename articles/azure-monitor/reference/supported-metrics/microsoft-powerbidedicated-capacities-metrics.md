...
|---|---|---|---|---|---|---|---|
|**CPU (Gen2)**<br><br>CPU Utilization. Supported only for Power BI Embedded Generation 2 resources. |`cpu_metric` | No | Percent |Average |\<none\>|PT1M |Yes|
|**Overload (Gen2)**<br><br>Resource Overload, 1 if resource is overloaded, otherwise 0. Supported only for Power BI Embedded Generation 2 resources. |`overload_metric` | No | Count |Average |\<none\>|PT1M |Yes|
