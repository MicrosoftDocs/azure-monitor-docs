...
|---|---|---|---|---|---|
|ASRv2 Health Event Data|Yes||No|No||
|ASRv2 Job Event Data|Yes||No|No||
|ASRv2 Protected Item Data|Yes|[ASRv2ProtectedItems](/azure/azure-monitor/reference/tables/asrv2protecteditems)<p>This table contains records of Azure Site Recovery v2 (ASRv2) protected item related events.|Yes|Yes||
|ASRv2 Replication Extension Data|Yes||No|No||
|ASRv2 Replication Policy Data|Yes||No|No||
|ASRv2 Replication Vault Data|Yes|[ASRv2ReplicationVaults](/azure/azure-monitor/reference/tables/asrv2replicationvaults)<p>This table contains records of Azure Site Recovery v2 (ASRv2) replication vault related events.|Yes|Yes||
