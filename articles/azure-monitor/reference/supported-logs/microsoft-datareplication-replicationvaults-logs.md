...
|---|---|---|---|---|---|
|HealthEvents|Yes||No|No||
|JobEvents|Yes||No|No||
|ProtectedItems|Yes|[ASRv2ProtectedItems](/azure/azure-monitor/reference/tables/asrv2protecteditems)<p>This table contains records of Azure Site Recovery v2 (ASRv2) protected item related events.|Yes|Yes||
|ReplicationExtensions|Yes||No|No||
|ReplicationPolicies|Yes||No|No||
|ReplicationVaults|Yes|[ASRv2ReplicationVaults](/azure/azure-monitor/reference/tables/asrv2replicationvaults)<p>This table contains records of Azure Site Recovery v2 (ASRv2) replication vault related events.|Yes|Yes||
