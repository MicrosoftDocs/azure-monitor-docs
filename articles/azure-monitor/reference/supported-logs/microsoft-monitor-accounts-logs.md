...
|---|---|---|---|---|---|
|MetricsUsageDetails|Yes|[AMWMetricsUsageDetails](/azure/azure-monitor/reference/tables/amwmetricsusagedetails)<p>Table that breaks down data quantities and query usage of metrics sent to an Azure Monitor Workspace.|Yes|Yes||
