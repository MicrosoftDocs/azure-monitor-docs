...
|---|---|---|---|---|---|
|AuditLogs|Yes|[AHDSDeidAuditLogs](/azure/azure-monitor/reference/tables/ahdsdeidauditlogs)<p>Data plane audit logs of privileged actions made against Azure Health Data Services de-identification service, such as initiating a de-identification job.|Yes|Yes||
