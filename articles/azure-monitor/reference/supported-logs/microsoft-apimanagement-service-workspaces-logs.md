...
|---|---|---|---|---|---|
|Gateway logs for API Management workspaces|Yes|[AzureDiagnostics](/azure/azure-monitor/reference/tables/azurediagnostics)<p>Logs from multiple Azure resources.|No|No||
