...
# Supported logs for Microsoft.HorizonDB/clusters

The following table lists the types of logs available for the Microsoft.HorizonDB/clusters resource type.

For a list of supported metrics, see [Supported metrics - Microsoft.HorizonDB/clusters](../supported-metrics/microsoft-horizondb-clusters-metrics.md)
