...
|---|---|---|---|---|---|
|Connection events (New Connection/Authentication/Disconnection)|Yes|[REDConnectionEvents](/azure/azure-monitor/reference/tables/redconnectionevents)<p>Logs the connection events when client connects to redis enterprise database.|Yes|Yes|[Queries](/azure/azure-monitor/reference/queries/redconnectionevents)|
