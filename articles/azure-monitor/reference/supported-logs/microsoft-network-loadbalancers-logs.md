...
|---|---|---|---|---|---|
|Load Balancer Health Event|Yes|[ALBHealthEvent](/azure/azure-monitor/reference/tables/albhealthevent)<p>Table of events related to the availability and health of a load balancer resource.|Yes|Yes|[Queries](/azure/azure-monitor/reference/queries/albhealthevent)|
