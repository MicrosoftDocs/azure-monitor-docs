...
|---|---|---|---|---|---|
|Login Events|No|[ContainerRegistryLoginEvents](/azure/azure-monitor/reference/tables/containerregistryloginevents)<p>Azure Container Registry Login Auditing Logs|No|Yes|[Queries](/azure/azure-monitor/reference/queries/containerregistryloginevents)|
|RepositoryEvent logs|No|[ContainerRegistryRepositoryEvents](/azure/azure-monitor/reference/tables/containerregistryrepositoryevents)<p>Azure Container Registry Repository Auditing Logs|No|Yes|[Queries](/azure/azure-monitor/reference/queries/containerregistryrepositoryevents)|
