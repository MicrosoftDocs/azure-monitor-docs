...
|---|---|---|---|---|---|
|Audit Logs|Yes|[ASCAuditLogs](/azure/azure-monitor/reference/tables/ascauditlogs)<p>Contains audit logs generated by Azure Sphere service and devices. Logs can be used for audit and troubleshooting.|Yes|Yes||
|Device Events|Yes|[ASCDeviceEvents](/azure/azure-monitor/reference/tables/ascdeviceevents)<p>Contains event details for operations generated by Azure Sphere devices. These logs contain information about event types, event categories, event classes, event descriptions etc. that can be used for monitoring and troubleshooting app crashes on devices.|Yes|Yes|[Queries](/azure/azure-monitor/reference/queries/ascdeviceevents)|
