...
|---|---|---|---|---|---|
|ServiceLog|Yes||No|No||
|UserLog|Yes|[EdgeActionConsoleLog](/azure/azure-monitor/reference/tables/edgeactionconsolelog)<p>Logs emitted to console by the action code.|Yes|No|[Queries](/azure/azure-monitor/reference/queries/edgeactionconsolelog)|
