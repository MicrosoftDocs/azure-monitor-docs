...
|---|---|---|---|---|---|---|
|`TrafficControllerAccessLog` |Application Gateway for Containers Access Log |[AGCAccessLogs](/azure/azure-monitor/reference/tables/agcaccesslogs)<p>Contains details of client requests made to Application Gateway for Containers. Each client request creates a log entry that can be used to identify slow requests, determine error rates, and correlate logs with backend services.|Yes|Yes|[Queries](/azure/azure-monitor/reference/queries/agcaccesslogs)|Yes |
