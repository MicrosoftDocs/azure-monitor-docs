...
|---|---|---|---|---|---|
|Log Errors|Yes|[AzureMonitorPipelineLogErrors](/azure/azure-monitor/reference/tables/azuremonitorpipelinelogerrors)<p>Errors occurred during Azure Monitor pipeline data collection, transformation, and export.|Yes|No|[Queries](/azure/azure-monitor/reference/queries/azuremonitorpipelinelogerrors)|
