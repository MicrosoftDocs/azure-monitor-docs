...
|---|---|---|---|---|---|
|Resource Provisioning Logs|Yes|[MDPResourceLog](/azure/azure-monitor/reference/tables/mdpresourcelog)<p>Logs pertaining to the provisioning agent resources for a Managed DevOps Pool.|Yes|Yes||
