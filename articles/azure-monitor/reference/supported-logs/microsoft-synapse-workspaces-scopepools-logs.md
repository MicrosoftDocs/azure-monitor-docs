...
|---|---|---|---|---|---|
|ScopePoolScopeJobsEnded|Yes|[SynapseScopePoolScopeJobsEnded](/azure/azure-monitor/reference/tables/synapsescopepoolscopejobsended)<p>SCOPE ended event including SCOPE job result and Information about the job.|No|Yes||
|ScopePoolScopeJobsStateChange|Yes||No|No||
