...
|---|---|---|---|---|---|
|Cloud Init Diagnostic Logs|Yes||No|No||
|Cluster Manager Deploy or Upgrade Logs|Yes|[NCMClusterOperationsLogs](/azure/azure-monitor/reference/tables/ncmclusteroperationslogs)<p>Cluster Manager logs to track the deployment or upgrade of Nexus cluster.|Yes|Yes||
