...
|---|---|---|---|---|---|
|CloudInitDiagnostics|Yes||No|No||
|ClusterManagerDeployOrUpgradeLogs|Yes|[NCMClusterOperationsLogs](/azure/azure-monitor/reference/tables/ncmclusteroperationslogs)<p>Cluster Manager logs to track the deployment or upgrade of Nexus cluster.|Yes|Yes||
