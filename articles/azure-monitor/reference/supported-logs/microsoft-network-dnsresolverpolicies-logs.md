...
|---|---|---|---|---|---|
|DNS Response|Yes|[DNSQueryLogs](/azure/azure-monitor/reference/tables/dnsquerylogs)<p>DNS query logs enable customers to monitor the DNS traffic in their virtual networks and help securing their DNS infrastructure.|Yes|Yes|[Queries](/azure/azure-monitor/reference/queries/dnsquerylogs)|
