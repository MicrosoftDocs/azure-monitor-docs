...
|---|---|---|---|---|---|
|Log Errors|Yes|[DCRLogErrors](/azure/azure-monitor/reference/tables/dcrlogerrors)<p>Errors registered during DCR-based data collection and transformation.|No|Yes|[Queries](/azure/azure-monitor/reference/queries/dcrlogerrors)|
