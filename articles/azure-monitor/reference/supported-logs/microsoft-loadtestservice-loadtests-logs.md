...
|---|---|---|---|---|---|
|OperationLogs|Yes|[AzureLoadTestingOperation](/azure/azure-monitor/reference/tables/azureloadtestingoperation)<p>Details about the operations which are performed on the Azure Load Testing resource. For example, operations like creation of a Test, Test run etc.|No|Yes|[Queries](/azure/azure-monitor/reference/queries/azureloadtestingoperation)|
