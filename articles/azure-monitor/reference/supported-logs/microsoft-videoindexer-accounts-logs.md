...
|---|---|---|---|---|---|
|Audit|Yes|[VIAudit](/azure/azure-monitor/reference/tables/viaudit)<p>Audit logs from Video Indexer.|No|Yes|[Queries](/azure/azure-monitor/reference/queries/viaudit)|
|IndexingLogs|Yes|[VIIndexing](/azure/azure-monitor/reference/tables/viindexing)<p>Indexing logs from Video Indexer.|No|Yes|[Queries](/azure/azure-monitor/reference/queries/viindexing)|
