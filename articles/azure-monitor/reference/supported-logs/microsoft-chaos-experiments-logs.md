...
|---|---|---|---|---|---|
|ExperimentOrchestration|Yes|[ChaosStudioExperimentEventLogs](/azure/azure-monitor/reference/tables/chaosstudioexperimenteventlogs)<p>Chaos Studio Experiment Orchestration events. Displays Start/Stop events of each Step/Branch/Action in experiment runs.|Yes|Yes|[Queries](/azure/azure-monitor/reference/queries/chaosstudioexperimenteventlogs)|
