...
|---|---|---|---|---|---|
|AuditLogs|No|[MicrosoftHealthcareApisAuditLogs](/azure/azure-monitor/reference/tables/microsofthealthcareapisauditlogs)<p>Azure API for FHIR audit logs|No|Yes||
|DiagnosticLogs|Yes||No|No||
