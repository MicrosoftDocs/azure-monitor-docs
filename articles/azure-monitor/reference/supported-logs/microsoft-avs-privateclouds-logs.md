...
|---|---|---|---|---|---|
|VMware Syslog|Yes|[AVSSyslog](/azure/azure-monitor/reference/tables/avssyslog)<p>Contains all system logs generated by VMWare applications, including (but not limited to) VCenter, NSX, and more.|Yes|Yes|[Queries](/azure/azure-monitor/reference/queries/avssyslog)|
