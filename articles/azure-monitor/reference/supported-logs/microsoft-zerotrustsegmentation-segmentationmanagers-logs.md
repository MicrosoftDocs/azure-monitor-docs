...
|---|---|---|---|---|---|
|Segmentation Manager Request Log|Yes|[ZTSRequest](/azure/azure-monitor/reference/tables/ztsrequest)<p>Requests made to the Zero Trust Segmentation service.|Yes|Yes|[Queries](/azure/azure-monitor/reference/queries/ztsrequest)|
|Segmentation Manager Job Status Log|Yes||No|No||
