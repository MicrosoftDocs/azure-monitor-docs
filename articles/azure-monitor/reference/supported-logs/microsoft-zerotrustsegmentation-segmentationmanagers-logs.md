...
|---|---|---|---|---|---|
|Request|Yes|[ZTSRequest](/azure/azure-monitor/reference/tables/ztsrequest)<p>Requests made to the Zero Trust Segmentation service.|Yes|Yes|[Queries](/azure/azure-monitor/reference/queries/ztsrequest)|
|ZTSJobStatus|Yes||No|No||
