...
|---|---|---|---|---|
| [AHDSDeidAuditLogs](ahdsdeidauditlogs.md)<p>Data plane audit logs of privileged actions made against Azure Health Data Services de-identification service, such as initiating a de-identification job. | audit, resources | LogManagement | Yes| -|
