...
| ProductName | string | The name of the product which published this alert, i.e. Microsoft Defender for Cloud, Azure ATP, Microsoft Defender ATP, O365 ATP, MCAS, etc. |
