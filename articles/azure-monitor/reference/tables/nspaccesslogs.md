...
| AppId | string | Unique GUID representing the app ID of resource in the Microsoft Entra ID. |
...
| SourceAppId | string | Unique GUID representing the app ID of source in the Microsoft Entra ID. |
