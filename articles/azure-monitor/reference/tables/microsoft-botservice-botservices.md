...
|---|---|---|---|---|
| [ABSBotRequests](absbotrequests.md)<p>Logs of requests made by Azure Bot Service on behalf of a bot such as requests from channel to bot and to other dependencies. | resources | LogManagement | No| [Yes](/azure/azure-monitor/reference/queries/absbotrequests)|
