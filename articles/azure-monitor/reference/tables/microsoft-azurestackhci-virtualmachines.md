...
| [HealthStateChangeEvent](/azure/azure-monitor/reference/tables/HealthStateChangeEvent)<p>Workload Monitor Health. This data represents state transitions of a health monitor. |  | AzureResources, VMInsights | No| -|
