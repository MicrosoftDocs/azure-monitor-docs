...
|---|---|---|---|---|
| [AZMSHybridConnectionsEvents](azmshybridconnectionsevents.md)<p>Captures all hybrid connection events that are performed on the Azure Relay namespace. | resources, audit | LogManagement | Yes| [Yes](/azure/azure-monitor/reference/queries/azmshybridconnectionsevents)|
