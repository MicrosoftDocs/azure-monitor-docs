...
| [DNSQueryLogs](dnsquerylogs.md)<p>DNS query logs enable customers to monitor the DNS traffic in their virtual networks and help securing their DNS infrastructure. | resources | LogManagement | Yes| [Yes](/azure/azure-monitor/reference/queries/dnsquerylogs)|
