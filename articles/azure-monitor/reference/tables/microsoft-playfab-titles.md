...
|---|---|---|---|---|
| [PFTitleAuditLogs](pftitleauditlogs.md)<p>Provides audit logs for various types of action performed on Azure PlayFab Title. | audit, resources | LogManagement | No| -|
