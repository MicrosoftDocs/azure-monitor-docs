...
| EventSchemaVersion | string | Microsoft Sentinel Schema Version. |
...
| EventTimeIngested | datetime | The time the event was ingested to Microsoft Sentinel. Will be added by Microsoft Sentinel. |
