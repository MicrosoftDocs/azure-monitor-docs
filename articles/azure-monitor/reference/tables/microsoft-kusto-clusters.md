...
|---|---|---|---|---|
| [ADXCommand](/azure/azure-monitor/reference/tables/ADXCommand)<p>Azure Data Explorer command execution summary. |  | LogManagement | No| -|
| [ADXIngestionBatching](/azure/azure-monitor/reference/tables/ADXIngestionBatching)<p>Azure Data Explorer ingestion batching operations. These logs have detailed statistics of batches ready for ingestion (duration, batch size and blobs count). |  | LogManagement | No| [Yes](/azure/azure-monitor/reference/queries/adxingestionbatching)|
...
| [ADXQuery](/azure/azure-monitor/reference/tables/ADXQuery)<p>Azure Data Explorer query execution summary. |  | LogManagement | No| -|
...
| [ADXTableUsageStatistics](/azure/azure-monitor/reference/tables/ADXTableUsageStatistics)<p>Azure Data Explorer table usage statistics. |  | LogManagement | No| [Yes](/azure/azure-monitor/reference/queries/adxtableusagestatistics)|
