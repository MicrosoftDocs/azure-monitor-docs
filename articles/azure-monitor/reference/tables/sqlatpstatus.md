...
SQL Advanced Threat Protection status log. The logs allow identifying machines connected to the workspace with SQL ATP and the protection status on each instance on those machines.
