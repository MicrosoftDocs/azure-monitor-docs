...
|---|---|---|---|---|
| [AmlRegistryReadEventsLog](amlregistryreadeventslog.md)<p>Azure ML Registry Read events log. It keeps records of Read operations with registries data access (data plane), including user identity, asset name and version for each access event. | audit, resources | LogManagement | No| -|
| [AmlRegistryWriteEventsLog](amlregistrywriteeventslog.md)<p>Azure ML Registry Write events log. It keeps records of Write operations with registries data access (data plane), including user identity, asset name and version for each access event. | audit, resources | LogManagement | No| [Yes](/azure/azure-monitor/reference/queries/amlregistrywriteeventslog)|
