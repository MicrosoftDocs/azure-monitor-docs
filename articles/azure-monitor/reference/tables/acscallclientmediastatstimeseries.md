...
Call client media stats logs provide media statistics about a call made through ACS. These logs are used to provide granular time series for quality metrics in Call Diagnostics Center. The logs contain information about media stream type, direction, codec as well as bitrate properties (e.g. max, min, average).
