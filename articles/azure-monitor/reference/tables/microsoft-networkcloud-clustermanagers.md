...
| [NCMClusterOperationsLogs](ncmclusteroperationslogs.md)<p>Cluster Manager logs to track the deployment or upgrade of Nexus cluster. | resources | LogManagement | Yes| -|
