...
This table is populated by Microsoft Sentinel UEBA with all your users account identities information. It can be used to correlate user information and insights with analytics or hunting queries.
