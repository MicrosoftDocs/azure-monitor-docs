...
Microsoft Sentinel confidential Watchlist contains imported data from CSV files that can be used to join or filter as an alert/incident condition.
...
| EntityMapping | dynamic | The JSON object with Microsoft Sentinel entity mapping to input columns. |
