...
- [LedgerUserDefinedLogs](./tables/ledgeruserdefinedlogs.md)
...
- [AADAgentRiskEvents](./tables/aadagentriskevents.md)
...
- [AADRiskyAgents](./tables/aadriskyagents.md)
...
- [CloudHsmHardwareOperationAuditLogs](./tables/cloudhsmhardwareoperationauditlogs.md)
...
- [ContainerAppHTTPLogs](./tables/containerapphttplogs.md)
...
- [DiscoveryBookshelfAuditLogs](./tables/discoverybookshelfauditlogs.md)
- [DiscoverySupercomputerAuditLogs](./tables/discoverysupercomputerauditlogs.md)
...
- [LedgerTransactionLogs](./tables/ledgertransactionlogs.md)
- [LedgerUserDefinedLogs](./tables/ledgeruserdefinedlogs.md)
- [MPCAuditLogs](./tables/mpcauditlogs.md)
- [MPCIngestionLogs](./tables/mpcingestionlogs.md)
- [MicrosoftGraphActivityLogs](./tables/microsoftgraphactivitylogs.md)
- [MicrosoftGraphPolicyLogs](./tables/microsoftgraphpolicylogs.md)
...
- [PreAuthenticationDiscoveryLogs](./tables/preauthenticationdiscoverylogs.md)
- [QuantumProviderAccountJobAuditLogs](./tables/quantumprovideraccountjobauditlogs.md)
- [QuantumProviderAccountMessageAuditLogs](./tables/quantumprovideraccountmessageauditlogs.md)
- [QuantumProviderAccountQueueAuditLogs](./tables/quantumprovideraccountqueueauditlogs.md)
- [QuantumProviderAccountTargetAuditLogs](./tables/quantumprovideraccounttargetauditlogs.md)
...
- [SecurityCaseEvent](./tables/securitycaseevent.md)
...
- [ZTSJobStatus](./tables/ztsjobstatus.md)
...
- [Windows365CheckpointLogs](./tables/windows365checkpointlogs.md)
- [Windows365ConnectionErrorLogs](./tables/windows365connectionerrorlogs.md)
- [Windows365ConnectionLogs](./tables/windows365connectionlogs.md)
...
- [DatabricksBrickStoreHttpGateway](./tables/databricksbrickstorehttpgateway.md)
- [DatabricksBudgetPolicyCentral](./tables/databricksbudgetpolicycentral.md)
- [DatabricksCapsule8Dataplane](./tables/databrickscapsule8dataplane.md)
- [DatabricksClamAVScan](./tables/databricksclamavscan.md)
- [DatabricksCloudStorageMetadata](./tables/databrickscloudstoragemetadata.md)
- [DatabricksClusterLibraries](./tables/databricksclusterlibraries.md)
- [DatabricksClusterPolicies](./tables/databricksclusterpolicies.md)
...
- [DatabricksDeltaPipelines](./tables/databricksdeltapipelines.md)
...
- [DatabricksMarketplaceConsumer](./tables/databricksmarketplaceconsumer.md)
- [DatabricksMarketplaceProvider](./tables/databricksmarketplaceprovider.md)
- [DatabricksModelRegistry](./tables/databricksmodelregistry.md)
- [DatabricksNotebook](./tables/databricksnotebook.md)
- [DatabricksOnlineTables](./tables/databricksonlinetables.md)
- [DatabricksPartnerHub](./tables/databrickspartnerhub.md)
- [DatabricksPredictiveOptimization](./tables/databrickspredictiveoptimization.md)
- [DatabricksRBAC](./tables/databricksrbac.md)
- [DatabricksRFA](./tables/databricksrfa.md)
- [DatabricksRemoteHistoryService](./tables/databricksremotehistoryservice.md)
- [DatabricksRepos](./tables/databricksrepos.md)
...
- [NCCKubernetesAPIAuditLogs](./tables/ncckubernetesapiauditlogs.md)
...
- [QuantumProviderAccountDeviceOperationLogs](./tables/quantumprovideraccountdeviceoperationlogs.md)
- [REDConnectionEvents](./tables/redconnectionevents.md)
...
- [ZTSGraph](./tables/ztsgraph.md)
- [ZTSJobStatus](./tables/ztsjobstatus.md)
- [ZTSMetadata](./tables/ztsmetadata.md)
- [ZTSRequest](./tables/ztsrequest.md)
...
- [NTANspRuleRecommendation](./tables/ntansprulerecommendation.md)
...
- [RemoteNetworkHealthLogs](./tables/remotenetworkhealthlogs.md)
- [Windows365NetworkLogs](./tables/windows365networklogs.md)
- [ZTSGraph](./tables/ztsgraph.md)
- [ZTSRequest](./tables/ztsrequest.md)
...
- [CloudDnsEvents](./tables/clouddnsevents.md)
...
- [CrowdStrikeAuditEvents](./tables/crowdstrikeauditevents.md)
...
- [DeviceCustomRegistryEvents](./tables/devicecustomregistryevents.md)
...
- [SentinelAlibabaCloudAPIGatewayLogs](./tables/sentinelalibabacloudapigatewaylogs.md)
- [SentinelAlibabaCloudVPCFlowLogs](./tables/sentinelalibabacloudvpcflowlogs.md)
- [SentinelAlibabaCloudWAFLogs](./tables/sentinelalibabacloudwaflogs.md)
- [SentinelAudit](./tables/sentinelaudit.md)
