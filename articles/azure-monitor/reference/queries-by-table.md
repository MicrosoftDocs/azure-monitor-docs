...
## [ASimAgentEventLogs](./queries/ASimAgentEventLogs.md)

- [View ASim Agent Event Logs](./queries/ASimAgentEventLogs.md#view-asim-agent-event-logs)

## [ASimAlertEventLogs](./queries/ASimAlertEventLogs.md)

- [View ASim AlertEvent Logs](./queries/ASimAlertEventLogs.md#view-asim-alertevent-logs)

## [ASimAssetEntityLogs](./queries/ASimAssetEntityLogs.md)

- [View ASim AssetEntity Logs](./queries/ASimAssetEntityLogs.md#view-asim-assetentity-logs)
...
## [AgentsInfo](./queries/AgentsInfo.md)

- [Active AI Agents by Owner](./queries/AgentsInfo.md#active-ai-agents-by-owner)
- [AI Agents by Platform and Model](./queries/AgentsInfo.md#ai-agents-by-platform-and-model)
...
## [AzureMonitorPipelineLogErrors](./queries/AzureMonitorPipelineLogErrors.md)

- [Azure Monitor pipeline errors](./queries/AzureMonitorPipelineLogErrors.md#azure-monitor-pipeline-errors)

## [AzureSQLAutomaticTuning](./queries/AzureSQLAutomaticTuning.md)

- [Automatic Tuning Sample Query](./queries/AzureSQLAutomaticTuning.md#automatic-tuning-sample-query)

## [AzureSQLBlocks](./queries/AzureSQLBlocks.md)

- [Blocks Sample Query](./queries/AzureSQLBlocks.md#blocks-sample-query)

## [AzureSQLDatabaseWaitStatistics](./queries/AzureSQLDatabaseWaitStatistics.md)

- [Database Wait Statistics Sample Query](./queries/AzureSQLDatabaseWaitStatistics.md#database-wait-statistics-sample-query)

## [AzureSQLDeadlocks](./queries/AzureSQLDeadlocks.md)

- [Deadlocks Sample Query](./queries/AzureSQLDeadlocks.md#deadlocks-sample-query)

## [AzureSQLErrors](./queries/AzureSQLErrors.md)

- [Errors Sample Query](./queries/AzureSQLErrors.md#errors-sample-query)

## [AzureSQLQueryStoreRuntimeStatistics](./queries/AzureSQLQueryStoreRuntimeStatistics.md)

- [Query Store Runtime Statistics Sample Query](./queries/AzureSQLQueryStoreRuntimeStatistics.md#query-store-runtime-statistics-sample-query)

## [AzureSQLQueryStoreWaitStatistics](./queries/AzureSQLQueryStoreWaitStatistics.md)

- [Query Store Wait Statistics Sample Query](./queries/AzureSQLQueryStoreWaitStatistics.md#query-store-wait-statistics-sample-query)

## [AzureSQLResourceUsageStats](./queries/AzureSQLResourceUsageStats.md)

- [Resource Usage Stats Sample Query](./queries/AzureSQLResourceUsageStats.md#resource-usage-stats-sample-query)

## [AzureSQLTimeouts](./queries/AzureSQLTimeouts.md)

- [Timeouts Sample Query](./queries/AzureSQLTimeouts.md#timeouts-sample-query)
...
## [CloudAuditEvents](./queries/CloudAuditEvents.md)

- [Top 10 cloud audit operations](./queries/CloudAuditEvents.md#top-10-cloud-audit-operations)
- [Cloud audit events from anonymous proxies](./queries/CloudAuditEvents.md#cloud-audit-events-from-anonymous-proxies)
- [Cloud resource deletion operations](./queries/CloudAuditEvents.md#cloud-resource-deletion-operations)
...
## [CloudProcessEvents](./queries/CloudProcessEvents.md)

- [Top 10 active Kubernetes pods](./queries/CloudProcessEvents.md#top-10-active-kubernetes-pods)
- [Process creation events in containers](./queries/CloudProcessEvents.md#process-creation-events-in-containers)
- [Suspicious commands in containers](./queries/CloudProcessEvents.md#suspicious-commands-in-containers)

## [CloudStorageAggregatedEvents](./queries/CloudStorageAggregatedEvents.md)

- [Top storage accounts by activity](./queries/CloudStorageAggregatedEvents.md#top-storage-accounts-by-activity)
- [Storage access from anonymous sources](./queries/CloudStorageAggregatedEvents.md#storage-access-from-anonymous-sources)
- [Storage access from suspicious IPs](./queries/CloudStorageAggregatedEvents.md#storage-access-from-suspicious-ips)
...
## [ContainerAppHTTPLogs](./queries/ContainerAppHTTPLogs.md)

- [Latest HTTP requests](./queries/ContainerAppHTTPLogs.md#latest-http-requests)
- [HTTP requests with non-success status codes](./queries/ContainerAppHTTPLogs.md#http-requests-with-non-success-status-codes)
- [HTTP response code distribution](./queries/ContainerAppHTTPLogs.md#http-response-code-distribution)
...
## [CopilotActivity](./queries/CopilotActivity.md)

- [Copilot Interactions by User](./queries/CopilotActivity.md#copilot-interactions-by-user)
- [Copilot Plugin Management Activity](./queries/CopilotActivity.md#copilot-plugin-management-activity)
- [Copilot PromptBook Management](./queries/CopilotActivity.md#copilot-promptbook-management)
- [Copilot Security and Compliance Events](./queries/CopilotActivity.md#copilot-security-and-compliance-events)
- [AI Model Usage Statistics](./queries/CopilotActivity.md#ai-model-usage-statistics)
- [Resources Accessed by Copilot](./queries/CopilotActivity.md#resources-accessed-by-copilot)
...
## [CrowdStrikeAuditEvents](./queries/CrowdStrikeAuditEvents.md)

- [Get sample of CrowdStrike Audit Event logs](./queries/CrowdStrikeAuditEvents.md#get-sample-of-crowdstrike-audit-event-logs)
- [Get CrowdStrike events by type](./queries/CrowdStrikeAuditEvents.md#get-crowdstrike-events-by-type)

## [CrowdStrikeCases](./queries/CrowdStrikeCases.md)

- [New cases by status](./queries/CrowdStrikeCases.md#new-cases-by-status)
...
## [DevOpsOperationsAudit](./queries/DevOpsOperationsAudit.md)

- [Succeeded DevOps Operations Audit Sample Query](./queries/DevOpsOperationsAudit.md#succeeded-devops-operations-audit-sample-query)
...
## [DiscoveryBookshelfAuditLogs](./queries/DiscoveryBookshelfAuditLogs.md)

- [All bookshelf audit events](./queries/DiscoveryBookshelfAuditLogs.md#all-bookshelf-audit-events)
- [Bookshelf operations by user](./queries/DiscoveryBookshelfAuditLogs.md#bookshelf-operations-by-user)
- [Bookshelf operations by type](./queries/DiscoveryBookshelfAuditLogs.md#bookshelf-operations-by-type)

## [DiscoverySupercomputerAuditLogs](./queries/DiscoverySupercomputerAuditLogs.md)

- [All supercomputer audit events](./queries/DiscoverySupercomputerAuditLogs.md#all-supercomputer-audit-events)
- [Supercomputer operations by user](./queries/DiscoverySupercomputerAuditLogs.md#supercomputer-operations-by-user)
- [Supercomputer operations by type](./queries/DiscoverySupercomputerAuditLogs.md#supercomputer-operations-by-type)

## [DiscoveryWorkspaceAuditLogs](./queries/DiscoveryWorkspaceAuditLogs.md)

- [All workspace audit events](./queries/DiscoveryWorkspaceAuditLogs.md#all-workspace-audit-events)
- [Workspace operations by user](./queries/DiscoveryWorkspaceAuditLogs.md#workspace-operations-by-user)
- [Workspace operations by type](./queries/DiscoveryWorkspaceAuditLogs.md#workspace-operations-by-type)
...
## [EdgeActionServiceLog](./queries/EdgeActionServiceLog.md)

- [Top 100 Log Messages by Edge Action Version](./queries/EdgeActionServiceLog.md#top-100-log-messages-by-edge-action-version)
- [Internal Errors by Edge Action Version](./queries/EdgeActionServiceLog.md#internal-errors-by-edge-action-version)
...
## [LedgerTransactionLogs](./queries/LedgerTransactionLogs.md)

- [Latest Ledger Transactions](./queries/LedgerTransactionLogs.md#latest-ledger-transactions)

## [LedgerUserDefinedLogs](./queries/LedgerUserDefinedLogs.md)

- [Latest Ledger User Defined Logs](./queries/LedgerUserDefinedLogs.md#latest-ledger-user-defined-logs)
...
## [NCCKubernetesAPIAuditLogs](./queries/NCCKubernetesAPIAuditLogs.md)

- [Volume of Kubernetes API audit events per source IP](./queries/NCCKubernetesAPIAuditLogs.md#volume-of-kubernetes-api-audit-events-per-source-ip)
- [Volume of Kubernetes API audit events per user](./queries/NCCKubernetesAPIAuditLogs.md#volume-of-kubernetes-api-audit-events-per-user)
- [Failed Kubernetes API requests](./queries/NCCKubernetesAPIAuditLogs.md#failed-kubernetes-api-requests)
- [Kubernetes deployment modification audit events](./queries/NCCKubernetesAPIAuditLogs.md#kubernetes-deployment-modification-audit-events)
...
## [QuantumProviderAccountDeviceOperationLogs](./queries/QuantumProviderAccountDeviceOperationLogs.md)

- [Quantum device operation pass rate (last 6 hours)](./queries/QuantumProviderAccountDeviceOperationLogs.md#quantum-device-operation-pass-rate-last-6-hours)
- [Quantum device operation duration by device (last 24 hours)](./queries/QuantumProviderAccountDeviceOperationLogs.md#quantum-device-operation-duration-by-device-last-24-hours)

## [QuantumProviderAccountMessageAuditLogs](./queries/QuantumProviderAccountMessageAuditLogs.md)

- [Provider message operations (last 24 hours)](./queries/QuantumProviderAccountMessageAuditLogs.md#provider-message-operations-last-24-hours)
- [Failed provider message operations (last 7 days)](./queries/QuantumProviderAccountMessageAuditLogs.md#failed-provider-message-operations-last-7-days)
- [Upcoming scheduled provider message windows](./queries/QuantumProviderAccountMessageAuditLogs.md#upcoming-scheduled-provider-message-windows)
...
## [Rapid7InsightVMCloudAssets](./queries/Rapid7InsightVMCloudAssets.md)

- [Rapid7 InsightVM Cloud Assets](./queries/Rapid7InsightVMCloudAssets.md#rapid7-insightvm-cloud-assets)

## [Rapid7InsightVMCloudVulnerabilities](./queries/Rapid7InsightVMCloudVulnerabilities.md)

- [Rapid7 InsightVM Cloud Vulnerabilities](./queries/Rapid7InsightVMCloudVulnerabilities.md#rapid7-insightvm-cloud-vulnerabilities)
...
## [SalesforceAuditTrail](./queries/SalesforceAuditTrail.md)

- [Recent setup changes](./queries/SalesforceAuditTrail.md#recent-setup-changes)

## [SalesforceLoginHistory](./queries/SalesforceLoginHistory.md)

- [Failed login attempts](./queries/SalesforceLoginHistory.md#failed-login-attempts)
...
## [SecurityCaseEvent](./queries/SecurityCaseEvent.md)

- [Recent changes on a case](./queries/SecurityCaseEvent.md#recent-changes-on-a-case)
- [Cases by status](./queries/SecurityCaseEvent.md#cases-by-status)
- [Cases with most open tasks](./queries/SecurityCaseEvent.md#cases-with-most-open-tasks)
- [Inactive cases](./queries/SecurityCaseEvent.md#inactive-cases)
- [Urgent open cases](./queries/SecurityCaseEvent.md#urgent-open-cases)
- [Cases with overdue tasks](./queries/SecurityCaseEvent.md#cases-with-overdue-tasks)
- [Case tasks created daily](./queries/SecurityCaseEvent.md#case-tasks-created-daily)
- [All case management activity by a specific user](./queries/SecurityCaseEvent.md#all-case-management-activity-by-a-specific-user)
- [Cases and tasks assigned to a specific user](./queries/SecurityCaseEvent.md#cases-and-tasks-assigned-to-a-specific-user)
- [Users with most open case tasks](./queries/SecurityCaseEvent.md#users-with-most-open-case-tasks)
- [Full cases snapshot (all cases)](./queries/SecurityCaseEvent.md#full-cases-snapshot-all-cases)
- [Single case snapshot](./queries/SecurityCaseEvent.md#single-case-snapshot)
- [Point-in-time single case snapshot](./queries/SecurityCaseEvent.md#point-in-time-single-case-snapshot)
- [Cases by SLA status](./queries/SecurityCaseEvent.md#cases-by-sla-status)
...
## [SentinelImpervaWAFCloudV2Logs](./queries/SentinelImpervaWAFCloudV2Logs.md)

- [Imperva WAF Cloud V2 Logs](./queries/SentinelImpervaWAFCloudV2Logs.md#imperva-waf-cloud-v2-logs)
...
## [StorageMoverCopyLogsFailed](./queries/StorageMoverCopyLogsFailed.md)

- [View copy logs](./queries/StorageMoverCopyLogsFailed.md#view-copy-logs)
...
- [Ingestion volume by table](./queries/Usage.md#ingestion-volume-by-table)
...
## [ZTSJobStatus](./queries/ZTSJobStatus.md)

- [View workspace connectivity issues](./queries/ZTSJobStatus.md#view-workspace-connectivity-issues)
