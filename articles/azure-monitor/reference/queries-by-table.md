...
## [StorageMoverCopyLogsTransferred](./queries/StorageMoverCopyLogsTransferred.md)

- [View copy logs Transferred](./queries/StorageMoverCopyLogsTransferred.md#view-copy-logs-transferred)
