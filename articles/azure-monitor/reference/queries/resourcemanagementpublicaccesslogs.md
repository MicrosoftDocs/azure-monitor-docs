...
Get the number of requests accessing the resource from an IP address.
...
### Number of operations triggered
...
Count the number of requests made based on operation name.
...
Count the number of requests made based on object identifiers.
