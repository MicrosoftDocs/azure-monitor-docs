...
:::image type="content" source="media/observability-agent-overview/investigation-results.png" alt-text="Screenshot of Azure Monitor investigation results showing findings, supporting data, and the Create Issue button." lightbox="media/observability-agent-overview/investigation-results.png":::
