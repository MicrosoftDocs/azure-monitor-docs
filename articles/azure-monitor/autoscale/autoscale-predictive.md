...
Predictive autoscale needs a minimum of seven days of history to provide predictions. The maximum sampling period is 15 days, which gives the best predictive results. For monthly or yearly workload patterns, use schedule-based autoscale or metric-based autoscale configurations. 
