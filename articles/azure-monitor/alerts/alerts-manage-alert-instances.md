...
You can also use the [Alert Management REST API](/azure/rest/api/monitor/alertsmanagement/operation-groups/alert-processing-rules) for lower-scale querying or to update fired alerts.
