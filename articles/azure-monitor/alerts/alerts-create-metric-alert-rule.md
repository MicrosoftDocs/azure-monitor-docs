...
> [!NOTE]
> If the metric used comes from a newly created resource, it is recommended to wait 10 to 15 minutes after the resource is created before the alert is generated.
