---
title: Customize Log Search Alert Email Subjects
...
# Customize log search alert email subjects
...
```bicep
resource performanceRule 'Microsoft.Insights/scheduledQueryRules@2023-12-01' = {
  name: 'performanceRule'
  kind: 'LogAlert'
  location: 'eastus'
  properties: {
