...
| targetResourceGroup | Name of the resource group for the impacted resource. |
| targetResourceType | The resource type affected by the alert. |
...
:::image type="content" source="media/alerts-common-schema/portal-opt-in.png" lightbox="media/alerts-common-schema/portal-opt-in.png" alt-text="Screenshot that shows the common alert schema opt-in." border="true":::
