...
|[Simple log search alerts](alerts-types.md#simple-log-search-alerts---preview) | Simple Log alerts allow users to use a Log Analytics query to evaluate each row individually.|
