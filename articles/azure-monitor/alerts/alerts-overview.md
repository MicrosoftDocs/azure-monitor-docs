...
|[Simple log search alerts - preview](alerts-types.md#simple-log-search-alerts) | Simple Log alerts allow users to use a Log Analytics query to evaluate each row individually.|
