...
To see how many log alert rules are currently in use, see [Check the total number of log alert rules in use](alerts-manage-alert-rules.md#log-alert-rule-quota).
