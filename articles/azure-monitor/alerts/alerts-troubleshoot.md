...
1. **Did the webhook trigger?**
    ...
    1. **Is the source IP address blocked?**
        ...
        Webhooks only support public networks and firewalls, [IP addresses](../fundamentals/azure-monitor-network-access.md) for all regions need to be in the allowlist. Add the IP addresses that the webhook is called from to your allowlist.
