...
- [Customize OpenTelemetry metric collection](./metrics-opentelemetry-guest-modify.md)
- [Collect OpenTelemetry Guest OS performance counters with a data collection rule](./data-collection-performance.md)
