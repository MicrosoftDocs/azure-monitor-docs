...
- Each entry must be JSON Line (aka JSONL or NDJSON) which is a single row of JSON and delineated with an end of line. Specifically, nesting and the JSON body format isn't supported. See sample below.
