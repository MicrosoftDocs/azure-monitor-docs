...
The ARM (JSON) and Bicep templates described in this section can be deployed using any method to install an [ARM (JSON)](/azure/azure-resource-manager/templates/overview) or [Bicep](/azure/azure-resource-manager/bicep/overview?tabs=bicep) template.
