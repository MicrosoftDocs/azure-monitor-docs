...
- [Tutorial: Collect guest logs from an Azure virtual machine](./tutorial-virtual-machine-collect-logs.md) - Walk through collecting Windows event logs or Syslog from a monitored VM.
