...
[Performance diagnostics (PerfInsights)](./performance-diagnostics.md) helps you identify and troubleshoot performance problems on Azure virtual machines. This article describes how to access the insights and reports that performance diagnostics generates and how to analyze the data.
...
Access the **Performance diagnostics reports** tab from the [Performance diagnostics](./performance-diagnostics-run.md#install-performance-diagnostics-on-a-vm) option for the VM. It lists all the [on-demand diagnostics](./performance-diagnostics.md#performance-diagnostics-modes) reports that you ran. The list shows the type of analysis that ran, the insights it found, and their impact levels.
