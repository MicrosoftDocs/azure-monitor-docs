...
On the **Collect and deliver** tab of the DCR, select **Performance Counters** from the **Data source type** dropdown. 
...
:::image type="content" source="media/data-collection-windows-event/verify-performance-counter.png" lightbox="media/data-collection-windows-event/verify-performance-counter.png" alt-text="Screenshot that shows records returned from Perf table." :::
