...
> [!IMPORTANT]
> The Azure Monitor doesn't support hibernation. If the agent computer hibernates, you might lose monitoring data. This will typically result in an error message similar to the following.
>
