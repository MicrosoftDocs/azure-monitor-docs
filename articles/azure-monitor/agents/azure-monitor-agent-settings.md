...
Monitor](../vm/data-collection.md#prerequisites)
...
1. Prepare the environment by installing the Azure Monitor Agent on 
your VM.
...
:::image type="content" source="articles/azure-monitor/agents/media/azure-monitor-agent-settings/azure-monitor-agent-dcr-edit-template-portal" alt-text="Screenshot that shows the deploy custom template in the search bar in the Azure portal.":::
