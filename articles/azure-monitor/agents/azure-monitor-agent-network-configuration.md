...
[Azure Virtual Network service tags](/azure/virtual-network/service-tags-overview) must be enabled on the virtual network for the virtual machine (VM). Both *AzureMonitor* and *AzureResourceManager* tags are required. See Azure Monitor entry in [Available service tags](/azure/virtual-network/service-tags-overview#available-service-tags) for any additional requirements.
