...
Per-vCPU throughput for CEF Fully Formed: ~6,500 logs/sec.
...
- **Variable payloads**: The baselines used identical ~1.2 KB messages. Real-world traffic with variable message sizes and formats might affect parsing throughput.
