...
> [!IMPORTANT]
> Starting March 1, 2026, the [Logs Ingestion API](../fundamentals/azure-monitor-network-access.md#log-ingestion-api-endpoints) requires TLS 1.2 or higher. For more information, see [Secure data in transit](../fundamentals/best-practices-security.md#secure-data-in-transit).
