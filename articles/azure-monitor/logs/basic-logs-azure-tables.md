...
| Cloud HSM | [CHSMManagementAuditLogs](/azure/azure-monitor/reference/tables/CHSMManagementAuditLogs)<br>[CHSMServiceOperationAuditLogs](/azure/azure-monitor/reference/tables/chsmserviceoperationauditlogs)<br>[CloudHsmServiceOperationAuditLogs](/azure/azure-monitor/reference/tables/CloudHsmServiceOperationAuditLogs)|
...
| Databricks |  [DatabricksApps](/azure/azure-monitor/reference/tables/DatabricksApps)<br>[DatabricksBudgetPolicyCentral](/azure/azure-monitor/reference/tables/DatabricksBudgetPolicyCentral)<br>[DatabricksClusterPolicies](/azure/azure-monitor/reference/tables/DatabricksClusterPolicies)<br>[DatabricksDataRooms](/azure/azure-monitor/reference/tables/DatabricksDataRooms)<br>[DatabricksGroups](/azure/azure-monitor/reference/tables/DatabricksGroups)<br>[DatabricksMarketplaceProvider](/azure/azure-monitor/reference/tables/DatabricksMarketplaceProvider)<br>[DatabricksOnlineTables](/azure/azure-monitor/reference/tables/DatabricksOnlineTables)<br>[DatabricksRBAC](/azure/azure-monitor/reference/tables/DatabricksRBAC)<br>[DatabricksRFA](/azure/azure-monitor/reference/tables/DatabricksRFA)<br>[DatabricksVectorSearch](/azure/azure-monitor/reference/tables/DatabricksVectorSearch)<br>[DatabricksWebhookNotifications](/azure/azure-monitor/reference/tables/DatabricksWebhookNotifications)<br>[DatabricksWorkspaceFiles](/azure/azure-monitor/reference/tables/DatabricksWorkspaceFiles) |
...
| Experiment workspaces | [AEWExperimentAssignmentSummary](/azure/azure-monitor/reference/tables/AEWExperimentAssignmentSummary)<br>[AEWExperimentScorecards](/azure/azure-monitor/reference/tables/AEWExperimentScorecards)<br>[AEWExperimentScorecardMetricPairs](/azure/azure-monitor/reference/tables/AEWExperimentScorecardMetricPairs)|
...
| Nexus Clusters |[NCCPlatformOperationsLogs](/azure/azure-monitor/reference/tables/NCCPlatformOperationsLogs)<br> [NCCKubernetesLogs](/azure/azure-monitor/reference/tables/NCCKubernetesLogs)<br>[NCCVMOrchestrationLogs](/azure/azure-monitor/reference/tables/NCCVMOrchestrationLogs) |
...
| Replication Vaults | [ASRv2ProtectedItems](/azure/azure-monitor/reference/tables/ASRv2ProtectedItems) |
