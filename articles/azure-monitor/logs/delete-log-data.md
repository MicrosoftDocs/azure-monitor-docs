...
> [!NOTE]
> Delete-data operation doesn't affect retention charge. The charge for retention is governed by the retention period configured your [workspace](./data-retention-configure.md#configure-the-default-interactive-retention-period-of-analytics-tables), or in [tables](./data-retention-configure.md#configure-table-level-retention) if applied.
