...
|---------------|----------------------|---------------------|----------------|
| **Azure** | [Diagnostic settings](../platform/diagnostic-settings.md) | | **Azure tenant** - Microsoft Entra audit logs provide sign-in activity history and audit trail of changes made within a tenant.<br/>**Azure resources** - Logs and performance counters.<br/>**Azure subscription** - Service health records along with records on any configuration changes made to the resources in your Azure subscription. |
