...
| Use summary tables to preaggregate large datasets for improved query performance. | Summary tables store preaggregated data that can be queried more efficiently than raw data. Use [summary rules](../summary-rules.md) to create and manage summary tables in your Log Analytics workspace. |
