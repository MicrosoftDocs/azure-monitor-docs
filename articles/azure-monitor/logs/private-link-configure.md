...
Connecting the Azure Monitor resources to the AMPLS is vital, as this process automatically creates the specific DNS entries required for each resource.
