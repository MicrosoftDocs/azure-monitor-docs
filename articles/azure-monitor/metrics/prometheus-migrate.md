...
Note that with the managed add-on, recommended recording rules are automatically setup as you enable Managed Prometheus for the AKS / ARC-enabled cluster. Review the list of automatically provisioned recording rules [here](../containers/prometheus-metrics-scrape-default.md#recording-rules).
