...
**Solution:** Export your metrics data to a [Log Analytics workspace](/azure/azure-monitor/logs/log-analytics-workspace-overview) and query from there. [Manage data retention](/azure/azure-monitor/logs/data-retention-configure) in your Log Analytics workspace. For more information on metrics export, see [Diagnostic settings in Azure Monitor](../data-collection/diagnostic-settings.md) and [Metrics export using data collection rules](../data-collection/metrics-export-create.md).
...
**Solution:** To route your diagnostic logs to Log Analytics, see [Diagnostic settings in Azure Monitor](../data-collection/diagnostic-settings.md).
