...
<sup>1</sup> Network security perimeters only work with [regional action groups](../alerts/action-groups.md#create-in-the-azure-portal). Global action groups default to public network access.
