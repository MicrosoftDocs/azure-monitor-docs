...
|Platform|[Send Azure Monitor activity log data](../platform/activity-log?tabs=powershell.md)|New article providing guidance for migration from self-hosted Prometheus.|
