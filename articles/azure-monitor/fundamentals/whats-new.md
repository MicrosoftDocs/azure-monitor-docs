...
|Application-Insights|[Application Insights telemetry data model - Azure Monitor | Microsoft Learn]()|We introduced substantial updates to the telemetry data model, simplifying and modernizing how telemetry is categorized and correlated. Key changes include expanded support for OpenTelemetry.|
