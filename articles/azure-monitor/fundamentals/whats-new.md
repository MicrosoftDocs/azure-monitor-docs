...
|Application-Insights|[.NET Classic API](../app/dotnet.md)|[Classic API](/previous-versions/azure/azure-monitor/app/classic-api) SDK information for .NET has been consolidated into a single article. Try the "Ask Learn" for AI assistance.|
|Application-Insights|[Node.js Classic API](../app/nodejs.md)|[Classic API](/previous-versions/azure/azure-monitor/app/classic-api) SDK information for Node.js has been consolidated into a single article. Try the "Ask Learn" for AI assistance.|
