...
|--------------------------------|-----------------------|------------------------------------------------------|-----------------|
| (any)                          | Azure Monitor         | [Auxiliary Logs Data Ingestion](../logs/cost-logs.md#table-plans)                        | yes             |
| (any)                          | Azure Monitor         | [Basic Logs Data Ingestion](../logs/cost-logs.md#table-plans)                      | yes             |
