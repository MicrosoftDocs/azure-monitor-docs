...
| [Logs query API batch operator](../logs/migrate-batch-and-beta.md#split-batch-queries-into-single-queries)<br>[Logs query API beta version](../logs/migrate-batch-and-beta.md#change-beta-path-to-v1) | This operation and version of the Logs query API is deprecated. See [Migrate from Logs query batch and beta](../logs/migrate-batch-and-beta.md) for timelines. |
