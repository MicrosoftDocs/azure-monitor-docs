...
Click **Apply** next to a recommendation to open the **Enablement** page, where you can configure and apply the recommended settings to multiple resources at once.
...
When you select a grouping, such as a specific recommendation, an **Apply** button is displayed next to each group. Click this button to open the **Enablement** page with all resources in that group pre-selected. 
