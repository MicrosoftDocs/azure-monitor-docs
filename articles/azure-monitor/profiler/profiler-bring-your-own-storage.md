...
description: Learn how to configure Bring Your Own Storage (BYOS) for Application Insights Profiler and Snapshot Debugger. BYOS is required when using Private Link or customer-managed keys.
