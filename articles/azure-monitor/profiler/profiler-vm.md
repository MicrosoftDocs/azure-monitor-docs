...
1. Select **Update**.
   ...
   :::image type="content" source="../app/media/dot-net/update-nuget-package.png" alt-text="Screenshot that shows where to select the Application Insights package for update.":::
