...
:::image type="content" source="media/resource-scoped-queries/image1.png" alt-text="Screenshot showing the Current Resource Prometheus data source option in Dashboards with Grafana.":::

:::image type="content" source="media/resource-scoped-queries/image2.png" alt-text="Screenshot showing how to configure resource-scoped queries in Dashboards with Grafana.":::
