...
If you use new settings in the dashboard preview, they might not work if you open the underlying workbook in the legacy workbooks experience. Dashboards are only available in the preview experience.
...
> [!NOTE]
> The dashboard preview doesn't have the full functionality of Workbooks. The product team is working every day to remove these limitations.

* You can add most item types to dashboards, including text, parameters, query, actions, image, and video items. Some item types aren't yet supported.
