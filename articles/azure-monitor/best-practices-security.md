...
- [Authentication of monitoring agents using managed identities for Application Insights and VM and container monitoring using Azure Monitor Agent](/identity/managed-identities-azure-resources/overview)
