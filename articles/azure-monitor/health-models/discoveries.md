...
:::image type="content" source="media/discoveries/discovery-types.png" lightbox="media/discoveries/discovery-types.png" alt-text="Screenshot of creating a discovery rule.":::

## Discovery types
There are three types of discoveries shown in the following table. You can use any combination of discoveries, including multiple discoveries of the same type, in a single health model depending on your requirements.
...
# [Application Insights topology](#tab/app-insights)
