...
| Core API (not a module) | —<br>(`Microsoft.ApplicationInsights package`)<br><br>[Microsoft.ApplicationInsights](https://www.nuget.org/packages/Microsoft.ApplicationInsights) NuGet package<br>**Note:** If you just install this NuGet, no .config file is 
