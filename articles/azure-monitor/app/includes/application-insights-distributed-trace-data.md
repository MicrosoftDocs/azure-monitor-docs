...
Azure Monitor provides two experiences for consuming distributed trace data: the [transaction diagnostics](../failures-performance-transactions.md#transaction-diagnostics-experience) view for a single transaction/request and the [application map](../app-map.md) view to show how systems interact.
