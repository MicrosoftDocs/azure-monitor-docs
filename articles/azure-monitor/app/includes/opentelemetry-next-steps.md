...
* To review the source code, see the [Azure Monitor ASP.NET Core GitHub repository](https://github.com/Azure/azure-sdk-for-net/tree/main/sdk/monitor/Azure.Monitor.OpenTelemetry.AspNetCore).
...
* To review a sample application, see [Telemetry for GraalVM native images](https://github.com/Azure-Samples/java-native-telemetry).
...
* To review the source code, see the [Azure Monitor OpenTelemetry for JavaScript repository](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/monitor/monitor-opentelemetry).
...
* To review the source code and extra documentation, see the [Azure Monitor Python GitHub repository](https://github.com/Azure/azure-sdk-for-python/blob/main/sdk/monitor/azure-monitor-opentelemetry/README.md).
* To review sample applications, see [Azure Monitor OpenTelemetry for Python](https://github.com/Azure/azure-sdk-for-python/tree/main/sdk/monitor/azure-monitor-opentelemetry/samples).
* To install the PyPI package and check for updates, see the [Azure Monitor Distro PyPI Package](https://pypi.org/project/azure-monitor-opentelemetry/) page.
