...
Add the JVM arg `-javaagent:"path/to/applicationinsights-agent-3.7.0.jar"` somewhere before `-jar`, for example:

```console
java -javaagent:"path/to/applicationinsights-agent-3.7.0.jar" -jar <myapp.jar>
```
