...
The live metrics experience uses different endpoints than other Application Insights telemetry. Make sure [those endpoints](../fundamentals/azure-monitor-network-access.md) are open in your firewall. Also check that [outgoing ports for live metrics](../fundamentals/azure-monitor-network-access.md#outgoing-ports) are open in the firewall of your servers.
