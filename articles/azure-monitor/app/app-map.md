...
* Application Insights SDK (Classic API): [.NET](classic-api.md&tabs=dotnet#add-a-cloud-role-name-and-cloud-role-instance) and [Node.js](classic-api.md&tabs=dotnet#add-a-cloud-role-name-and-cloud-role-instance)
