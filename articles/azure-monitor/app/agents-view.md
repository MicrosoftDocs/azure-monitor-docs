...
:::image type="content" source="media/agents-view/agent-details-grafana.png" lightbox="media/agents-view/agent-details-grafana.png" alt-text="A screenshot showing the 'Explore in Grafana' button.":::
