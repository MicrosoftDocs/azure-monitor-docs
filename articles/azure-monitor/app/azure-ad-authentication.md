...
Application Insights now supports [Microsoft Entra authentication](/entra/identity/authentication/overview). By using Microsoft Entra ID, you can ensure that only authenticated telemetry is ingested in your Application Insights resources.
