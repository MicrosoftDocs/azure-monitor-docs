...
> [!NOTE]
> For Azure Monitor's position on the OpenTelemetry-Collector, see the [OpenTelemetry FAQ](./opentelemetry-faq.md#can-i-use-the-opentelemetry-collector).
...
Check out the [Azure Monitor Application Insights FAQ](./app-insights-overview.md#frequently-asked-questions) and [OpenTelemetry FAQ](./opentelemetry-faq.md#frequently-asked-questions) for more information.
