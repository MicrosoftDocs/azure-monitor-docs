...
<!-- IMPORTANT: If you're updating this code example, please remember to also update it in: 1) articles\azure-monitor\app\javascript-sdk.md and 2) articles\azure-monitor\app\javascript-sdk-configuration.md -->
...
* See [Log Analytics tutorial](../logs/log-analytics-tutorial.md#write-a-query) and [log queries in Azure Monitor Logs](../logs/get-started-queries.md) if you aren't familiar with the process of writing a query.
