...
| Telemetry type | Table name (Log Analytics) | Table name (Application Insights) | Description |
|----------------|----------------------------|-----------------------------------|-------------|
