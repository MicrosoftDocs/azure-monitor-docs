...
>
> This article lists all field names for Application Insights and Log Analytics. To compare those field names in the Azure portal, open *Application Insights* > *Logs*, run a query, and copy the `Id` of a telemetry item (for example, 1234a5b6c7de8f90). Then, open a new tab in your browser, go to **Log Analytics** > **Logs**, switch to **KQL mode**, and run the query:
>
> ```kusto
> AppDependencies
> | where Id == "9223e1c9f9eb2e42"
> ```
> 
> Expand both telemetry items by selecting the chevron to the left of each row.
