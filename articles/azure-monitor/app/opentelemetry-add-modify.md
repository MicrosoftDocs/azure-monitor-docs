...
[Application Insights](./app-insights-overview.md) stores custom events in the `customEvents` table. You can **analyze, filter, and visualize** them by using [Azure Monitor tools](./usage.md#slice-and-dice-custom-events).
