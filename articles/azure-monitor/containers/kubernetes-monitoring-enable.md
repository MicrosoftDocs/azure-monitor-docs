...
> [!NOTE]
> If you have a single Azure Monitor Resource that is private-linked, then Prometheus enablement won't work if the cluster and Azure Monitor Workspace are in different regions.
