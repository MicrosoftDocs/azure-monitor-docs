...
The onboarding and configuration processes described in this article support the following clusters.
...
- If you're using private link, see [Enable private link for Kubernetes monitoring in Azure Monitor](../fundamentals/azure-monitor-agent-private-link.mdkubernetes-monitoring-private-link.md).
