...
1. Follow the guidance in [Configure and deploy ConfigMap](./kubernetes-data-collection-configure.md#configure-and-deploy-configmap) to download and update ConfigMap for the cluster. 
