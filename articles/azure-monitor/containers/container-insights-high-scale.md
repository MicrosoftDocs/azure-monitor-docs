...
When the volume of logs generated is substantial, it can lead to throttling and log loss. See the *[Configure throttling for Container Insights](./container-insights-throttling)* article for guidance on configuring throttling parameters and monitoring for log loss. 
