...
> [!NOTE]
> If your AKS cluster isn't in the same region as your Azure Monitor Workspace, then you need to configure the Data Collection Endpoint for the Azure Monitor Workspace. 
