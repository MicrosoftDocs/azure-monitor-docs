...
| Control plane log collection | Control plane logs are implemented as [resource logs](../logs/resource-logs.md) in Azure Monitor. Create a [diagnostic setting](../data-collection/diagnostic-settings.md) to collect these logs in the same Log Analytics workspace as your container logs. |
