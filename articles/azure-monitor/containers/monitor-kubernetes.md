...
See [Enable monitoring for AKS clusters](./kubernetes-monitoring-enable.md) for prerequisites and configuration options for onboarding your Kubernetes clusters. Onboard using Azure Policy to ensure that all clusters retain a consistent configuration. 
