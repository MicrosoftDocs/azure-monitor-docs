...
6. If you want to customize the settings, click **Edit collection settings**.
    ...
    | Name | Description |
    |:---|:---|
    | Collection frequency | Determines how often the agent collects data.  Valid values are 1m - 30m in 1m intervals The default value is 1m. This option cannot be configured through the ConfigMap|
