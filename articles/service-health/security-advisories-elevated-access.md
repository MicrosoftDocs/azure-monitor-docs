...
>
>
>For more information about Sercurity advisories using ARG queries, see [Azure Resource Graph sample queries for Service health](resource-graph-samples?branch=main&tabs=azure-cli#all-active-service-issue-events.md). This resource provides guidance on how to utilize the available queries.
