...
Select the **Issue name** link to open the tabs with the complete information about each event. The information on this pane includes:
- Issue Name
- Tracking ID
- Event type
- Services
...
- Region
- Health event type
- Time Range (you can select last 24 hours up to the last three months)
