...
:::image type="content"source="./media/assign-roles/iam-screen.png"alt-text="A screenshot of subscription panel."Lightbox="./media/assign-roles/iam-screen.png":::
...
:::image type="content"source="./media/assign-roles/add-role.png"alt-text="A screenshot of subscription panel."Lightbox="./media/assign-roles/add-role.png":::
...
To ensure that security notifications are received, verify that the email address associated with the user in Azure Active Directory is current. 
