...
-  See [Introduction to Azure Service Health dashboard](service-health-portal-update.md) and [Introduction to Azure Resource Health](resource-health-overview.md) to understand more about them.
