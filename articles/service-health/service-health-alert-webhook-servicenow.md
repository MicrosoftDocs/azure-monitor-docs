...
1. Follow steps 1 through 8 in [Action groups](https://learn.microsoft.com/en-us/azure/azure-monitor/alerts/action-groups.md) and create an alert with a new action group.
