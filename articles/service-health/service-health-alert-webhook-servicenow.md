...
1. Follow steps 1 through 8 in [Action groups](/azure/azure-monitor/alerts/action-groups#create-in-the-azure-portal) and create an alert with a new action group.
