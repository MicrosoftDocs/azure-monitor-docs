...
---
# Send Azure service health alerts with PagerDuty by using webhooks
...
1.  Make sure you're signed up for and are signed into your [PagerDuty](https://www.pagerduty.com/) account.
...
1. Follow steps 1 through 8 in [Action Groups](/azure/azure-monitor/alerts/action-groups#create-in-the-azure-portal).
