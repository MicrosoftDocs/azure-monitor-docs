...
Users with *owner*, *contributor*, or *reader* roles on the subscription can view information on the Health history pane. For sensitive events like security advisories, you should have Role-based Access Control (RBAC) permissions. For more information, see [RBAC permissions](/azure/role-based-access-control/overview).
