...
> [!NOTE]
> Active Service issues are displayed for 90 days until resolved or updated, then moved to History. Issues older than 90 days aren't shown but are stored for a year and can be accessed via API query.
