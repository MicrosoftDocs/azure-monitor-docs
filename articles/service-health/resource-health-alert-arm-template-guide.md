...
By choosing the right scope, you ensure alerts are relevant and actionable. This choice helps you respond quickly to issues that could affect your critical workloads without unnecessary noise.
...
>[!TIP] 
> Select **Create action groups** and follow the prompts to set up your own action groups.
