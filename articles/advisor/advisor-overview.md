...
:::image type="content" source="./media/advisor-overview/advisor-reliability-recommendations-main-m-2.png" alt-text="Screenshot showing the Azure Advisor state management page." lightbox="./media/advisor-overview/advisor-reliability-recommendations-main-m-2.png":::
...
For more information, see: [Roles and Permissions](/articles/advisor/permissions)
...
For more information, see [Azure Advisor recommendation state management](/articles/advisor/advisor-azure-state-management.md).
