...
For the accurate state of a security recommendation, refer to its status in Microsoft Defender for Cloud: [Microsoft Defender for Cloud documentation](./articles/defender-for-cloud/index.yml)
