...
> For more information, see [What is Azure Service Health?](/articles/service-health/impacted-resources-retirements#Impacted-resources-from-Azure-Health-Advisories)

---
## For non-public clouds 
All channels support retirement recommendations only for Azure public cloud. For retirement recommendations on sovereign or national partner clouds, use [Azure Retirement Impact Analyzer](https://github.com/microsoft/azure-retirement-impact-analyzer).
...
[!INCLUDE [Table for retiring February 2024](./includes/retiring-feature/retirement-date-2024-02.md)]

#### Retiring August 2024

[!INCLUDE [Open Azure Advisor overview](./includes/retiring-feature/retirement-date-2024-08.md)]

#### Retiring October 2024

[!INCLUDE [Table for retiring October 2024](./includes/retiring-feature/retirement-date-2024-10.md)]
...
[!INCLUDE [Table for retiring May 2028](./includes/retiring-feature/retirement-date-2028-05.md)]
