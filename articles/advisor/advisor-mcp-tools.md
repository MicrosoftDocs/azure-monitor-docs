...
- The Azure MCP server configured in your client. For setup instructions, see [Get started with the Azure MCP server](/azure/developer/azure-mcp-server/get-started/tools/visual-studio-code).
