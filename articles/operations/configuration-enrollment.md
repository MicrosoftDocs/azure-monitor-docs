...
The user assigned managed identity also needs to have permissions to act on the following resource providers **Microsoft.Insights**, **Microsoft.Authorization**. Learn more [Configure assignment restriction for user-assigned managed identities](/entra/identity/managed-identities-azure-resources/configure-managed-identities-assignment-restriction)
