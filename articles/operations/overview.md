...
## Key Features
- Unified dashboard for operational data
- Agentic experience for guided troubleshooting
- Integration with Azure Monitor and other tools
- Scalable onboarding and licensing management
