...
1. **The Azure activity log for the target resource.** Service-direct Actions execute Azure Resource Manager operations, which appear in the [Azure activity log](../azure-monitor/fundamentals/activity-log.md) of the target resource. A failed operation there includes the underlying error detail.
