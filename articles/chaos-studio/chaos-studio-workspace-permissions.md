...
When you create a Workspace, you assign it a scope — the boundary of resources the Workspace can discover, target, and affect. Supported scope types:
